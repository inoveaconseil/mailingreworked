...
/**
 * \file    modulebuilder/template/core/boxes/mailingreworkedwidget1.php
 * \ingroup mailingreworked
 * \brief   Widget provided by Mailingreworked
 *
 ...
 */
class mailingreworkedwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "mailingreworkedbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "mailingreworked@mailingreworked";
	 ...
	 */
	public $depends = array('mailingreworked');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->mailingreworked->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/mailingreworked/class/mailingreworked.class.php";

		// Populate the head at runtime
		$text = $langs->trans("MailingreworkedBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_mailingreworked@mailingreworked',
