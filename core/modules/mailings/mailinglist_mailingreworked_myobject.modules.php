...
dol_include_once("/mailingreworked/class/myobject.class.php");


/**
 * mailing_mailinglist_mailingreworked
 */
class mailing_mailinglist_mailingreworked_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_mailingreworked_myobject';
	...
	var $picto='mailingreworked@mailingreworked';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('mailingreworked',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/mailingreworked/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_mailingreworked_myobject.modules.php: mailing ".$num." targets found");
