...
/**
 * \file    test/functional/MailingreworkedFunctionalTest.php
...
/**
 * Class MailingreworkedFunctionalTest
 *
 ...
 *
 * @package Testmailingreworked
 */
class MailingreworkedFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMailingreworked')->click();
		} else {
			// Disable the module
			$this->byHref('modMailingreworked')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mailingreworked/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mailingreworked/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mailingreworked/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mailingreworked/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mailingreworkedwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMailingreworked_MailingreworkedTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMailingreworked_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
