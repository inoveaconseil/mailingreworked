...
/**
 *	\file       htdocs/mailingreworked/template/mailingreworkedindex.php
 *	\ingroup    mailingreworked
 *	\brief      Home page of mailingreworked top menu
 */
...
$langs->loadLangs(array("mailingreworked@mailingreworked"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->mailingreworked->read) accessforbidden();
...
llxHeader("",$langs->trans("MailingreworkedArea"));
...
// Draft MyObject
if (! empty($conf->mailingreworked->enabled) && $user->rights->mailingreworked->read)
{
	$langs->load("orders");
