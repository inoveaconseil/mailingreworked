...
if ($action == 'create') {
	...
	print '<tr><td class="fieldrequired titlefieldcreate">' . $langs->trans("MailTopic") . '  <strong style="color: red" >*</strong></td><td><input class="flat minwidth200 quatrevingtpercent" name="sujet" value="' . dol_escape_htmltag(GETPOST('sujet')) . '"></td></tr>';
	...
	if ($object->id > 0) {
		...
		if ($action != 'edit' && $action != 'edithtml' && $action != 'visu') {
...
/*
		...
		elseif ($action == 'visu') {
			...
			print '<a class="button" style="color: #FFFFFF;margin-right: 11%; margin-top:-6.5%" href='.DOL_URL_ROOT."/custom/mailingreworked/card.php?id=".$object->id.'>Editer</a>';
			print '<div class="fichecenter">';
			print '<div class="underbanner clearboth"></div>';
